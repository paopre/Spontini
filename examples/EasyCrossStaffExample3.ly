...
\easyCrossStaff %TMODE
  { $lU1 \tupletUp 3/2 { \ottava #1 <c'''' e''''>8[( $lU2 \CS s   \CS s }    \CS e''''4) \ottava #0            \CS r \CS }
  { $lD1 \hiddenTuplet 3/2 { s8 $lD2                      \CS c'' \CS g''] } \CS s4\ff\sustainOff\sostenutoOff \CS s \CS }
#'( C                                                     \CS -   \CS -      \CS -                             \CS - \CS )
...
\easyCrossStaff %TMODE
  { $lU1 \tupletUp 3/2 { \ottava #1 s8 [ $lU2 \CS g''' \CS g'''] } \CS e''''4) \ottava #0            \CS r \CS }
  { $lD1 \hiddenTuplet 3/2 { c'''8 $lD2       \CS c''  \CS s }     \CS s4\ff\sustainOff\sostenutoOff \CS s \CS }
#'( U                                         \CS -    \CS -       \CS N                             \CS - \CS )
...
\easyCrossStaff %TMODE
  { $lU1 \tupletUp 3/2 { \ottava #1 g'''8  ^( $lU2 \CS s   \CS <g'' b''>} \CS e''''4) \ottava #0            \CS r \CS }
  { $lD1 \hiddenTuplet 3/2 {  s8 [  $lD2           \CS c'' \CS g''] }     \CS s4\ff\sustainOff\sostenutoOff \CS s \CS }
#'( D                                              \CS -   \CS -          \CS N                             \CS - \CS )
...
\easyCrossStaff %TMODE
  { $lU1 \hiddenTuplet 3/2 { \ottava #1 c''''8  $lU2 \CS s   \CS s }    \CS e''''4) \ottava #0            \CS r \CS }
  { $lD1 \tupletDown 3/2 { s8 [ $lD2                 \CS c'' \CS g''] } \CS s4\ff\sustainOff\sostenutoOff \CS s \CS }
#'( D                                                \CS -   \CS -      \CS N                             \CS - \CS )
