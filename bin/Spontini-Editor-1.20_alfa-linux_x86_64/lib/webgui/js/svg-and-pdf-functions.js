...
var showjssvg = "true"
var marker1Color = "rgb(12.3000%, 45.6000%, 78.9000%)"
var marker2Color = "rgb(98.7000%, 12.3000%, 45.6000%)"
var osPadderColor = "rgb(91.2000%, 93.4000%, 95.6000%)"
var pdfDoc = null
...
function setJSSVGVisibilityForLyGeneratedObjs(val) {
  ...
  var osopadderlines1 = document.querySelectorAll('svg [color="'+osPadderColor+'"]')
  ...
  var markers1 = document.querySelectorAll('svg [color="'+marker1Color+'"]')
  var markers2 = document.querySelectorAll('svg [color="'+marker2Color+'"]')
...
function isMarker(node) {
  ...
  return (node.nodeName == 'g' &&
          ...
          ((node.getAttributeNS(null, 'color') == marker1Color) ||
          (node.getAttributeNS(null, 'color') == marker2Color)))
...
function isOsPadder(node) {
  ...
  return (node.nodeName == 'g' &&
          node.getAttributeNS(null, 'color') &&
          ((node.getAttributeNS(null, 'color') == osPadderColor)))
