...
#{ \markup \translate $pt \with-color #(rgb-color 0.811 0.466 0.439) \draw-circle #0.6 #0 ##t #})
...
(if (string=? showEditorStuff "true") #{
  \OSOPadder #reservedColor2 #0.2 "true" #(string->number idStr) #vals #arg 
#}
#{ 
  \OSOPadder #white #0.2 "true" #(string->number idStr) #vals #arg 
#}))
